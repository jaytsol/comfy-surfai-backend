...
export class Migration1753204022086 implements MigrationInterface {
    name = 'Migration1753204022086'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "workflows" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" text, "category" character varying(100), "definition" jsonb, "parameter_map" jsonb, "previewImageUrl" text, "tags" text, "cost" integer NOT NULL DEFAULT '1', "isPublicTemplate" boolean NOT NULL DEFAULT false, "user_parameter_values" jsonb, "isTemplate" boolean NOT NULL DEFAULT true, "ownerUserId" integer, "sourceTemplateId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5b5757cc1cd86268019fef52e0c" PRIMARY KEY ("id")); COMMENT ON COLUMN "workflows"."category" IS 'Category of the workflow template (e.g., image, video)'; COMMENT ON COLUMN "workflows"."definition" IS 'ComfyUI workflow definition JSON'; COMMENT ON COLUMN "workflows"."parameter_map" IS 'Parameter mapping for the template'; COMMENT ON COLUMN "workflows"."cost" IS 'Cost to use this workflow template'; COMMENT ON COLUMN "workflows"."isPublicTemplate" IS 'Is this template available to all users?'; COMMENT ON COLUMN "workflows"."user_parameter_values" IS 'User-defined parameter values for this instance'; COMMENT ON COLUMN "workflows"."isTemplate" IS 'Is this record a template or a user instance?'`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "displayName" character varying NOT NULL, "password" character varying, "googleId" character varying, "imageUrl" character varying(2048), "role" "public"."users_role_enum" NOT NULL DEFAULT 'user', "currentHashedRefreshToken" character varying, "coinBalance" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_f382af58ab36057334fb262efd5" UNIQUE ("googleId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
