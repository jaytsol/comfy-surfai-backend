...
export class AddImageInputsToWorkflow1756131630056 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "workflows" DROP COLUMN IF EXISTS "input_image_count"`);
        await queryRunner.query(`ALTER TABLE "workflows" DROP COLUMN IF EXISTS "media_inputs"`);
